...
|   |   |-- config/        # Patrol, home, and docking-pose parameters
...
The expected sequence is `IDLE`, `WAITING_FOR_NAV2`,
`NAVIGATING_TO_STAGING`, `PRECISION_DOCKING`, and finally `DOCKED`.
...
- Add undocking and simulated charging
